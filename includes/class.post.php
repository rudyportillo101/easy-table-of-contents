	...
	private function createTOC( $page, $matches ) {
		...
		if ( $hierarchical ) {
          ...
          $html .= '<li>';
            ...
            $html .= '<button class="js-collapse" data-toggle="collapse" data-target="#collapse-' . $i . '" aria-expanded="false" aria-controls="collapse-' . $i . '"><img src="' . get_template_directory_uri() . '/assets/images/icons/caret-2.svg" data-no-lazy="1" width="9" height="18" loading="lazy" alt="" /></button>';
